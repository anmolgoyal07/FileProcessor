...
public class DirectoryProcessService {
	...
	FileWriter dmtdFileWriter;

	/*
	 * 1. Dir input
	 * 2. Read dir
	 * 	2.1 if file than process csv & txt file
	 *   2.1.1 get the list of in that folder
	 *   2.1.2 read,object(list<string) ,write  
	 *  2.2 if dir go to point 2
	 */
	public void processRootDir(String dirPath) throws IOException {
